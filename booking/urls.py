...
urlpatterns = [
    ...
    path('lessons/<int:booking_id>/complete/', views.complete_lesson, name='complete_lesson'),
    path('lessons/<int:booking_id>/not-held/', views.mark_lesson_not_held, name='mark_lesson_not_held'),
